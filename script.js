...
<head>
    ...
    <title>Sistema de Trading 2025 - EUR/USD</title>
    ...
    <style>
        * {
        ...
        body {
            ...
            background: linear-gradient(135deg, #13141a, #1a1c25);
            color: #f5f6fa;
            min-height: 100vh;
            padding: 20px;
            display: flex;
        ...
        @media (max-width: 768px) {
            .status-container, .data-container, .metrics-grid {
...
<body>
    <div class="container">
        <header>
            <h1><i class="fas fa-chart-line"></i> EUR/USD - Estratégia de Trading 2025</h1>
            <p class="subtitle">Sistema avançado de análise de mercado em tempo real</p>
        </header>
        
        <div class="status-container">
            <div id="comando" class="signal-box esperar">
                INICIANDO...
            </div>
            
            <div class="info-box">
                <div id="score" class="confidence">Carregando análise...</div>
                <div class="time-container">
                    <div class="time-card">
                        <div class="time-label">Última Atualização</div>
                        <div id="hora" class="time-value">--:--:--</div>
                    </div>
                    <div class="time-card">
                        <div class="time-label">Próxima Análise</div>
                        <div id="timer" class="time-value">0:60</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="metrics-grid">
            <div class="metric-card">
                <div class="metric-title"><i class="fas fa-chart-line metric-icon"></i> Força da Tendência</div>
                <div id="tendencia-container">
                    <span id="tendencia">--</span> 
                    <span id="forca-tendencia" class="metric-value trend-strength">--%</span>
                </div>
            </div>
            
            <div class="metric-card">
                <div class="metric-title"><i class="fas fa-random metric-icon"></i> Entropia do Mercado</div>
                <div id="entropia" class="metric-value entropy-value">--%</div>
            </div>
            
            <div class="metric-card">
                <div class="metric-title"><i class="fas fa-bolt metric-icon"></i> Volatilidade (ATR)</div>
                <div id="atr" class="metric-value volatility-value">--</div>
            </div>
        </div>
        
        <div class="data-container">
            <div class="data-card">
                <h3 class="data-title"><i class="fas fa-history"></i> Últimos Sinais</h3>
                <ul id="ultimos">
                    <li class="loading"><div class="loading-spinner"></div> Carregando histórico...</li>
                </ul>
            </div>
            
            <div class="data-card">
                <h3 class="data-title"><i class="fas fa-chart-bar"></i> Indicadores Avançados</h3>
                <ul id="criterios">
                    <li class="loading"><div class="loading-spinner"></div> Coletando dados de mercado...</li>
                </ul>
            </div>
        </div>
        
        <footer>
            Sistema de Trading 2025 | Dados em tempo real | Atualizado: <span id="current-time"></span>
        </footer>
    </div>
